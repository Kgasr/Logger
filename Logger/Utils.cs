namespace Logging
{
    public static class Utils
    {
        ...
        public static async Task LogDataWithExceptionAsync(string logRecord, Exception ex, string className, string filePath = null)
        {
            ...
            string tempLogFile = Constants.DefaultLogFile;
